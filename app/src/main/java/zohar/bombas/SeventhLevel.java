...
public class SeventhLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dgame.currLevel=6;
        t=(TextView)findViewById(R.id.tv7);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(6);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<7)
            {
                Dgame.scoreEdit.putInt("levelPassed", 7);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_seventh_level, menu);
        return true;
    }
