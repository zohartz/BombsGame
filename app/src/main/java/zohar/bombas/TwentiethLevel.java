...
public class TwentiethLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twentieth_level);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(19);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<20)
            {
                Dgame.scoreEdit.putInt("levelPassed", 20);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_twentieth_level, menu);
        return true;
    }
