...
public class SixthLevel extends AppCompatActivity{
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            if(Dgame.gamePrefs.getInt("levelPassed",0)<6)
            {
                Dgame.scoreEdit.putInt("levelPassed", 6);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if(!Dgame.xtreme) {
            getMenuInflater().inflate(R.menu.menu_sixth_level, menu);
            return true;
        }
        return false;
    }
