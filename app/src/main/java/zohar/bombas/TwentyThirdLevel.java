...
public class TwentyThirdLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twenty_third_level);
        Dgame.gamePrefs= getSharedPreferences(Dgame.GAME_PREFS, 0);
        Dgame.currLevel=22;
        t=(TextView)findViewById(R.id.tv23);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            {
                Dgame.scoreEdit.putInt("levelPassed", 23);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_twenty_third_level, menu);
        return true;
    }
