...
public class FourtyFifthLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourty_fifth_level);
        screen=(RelativeLayout)findViewById(R.id.flores);
        Dgame.gamePrefs= getSharedPreferences(Dgame.GAME_PREFS, 0);
        Dgame.currLevel=44;
        t=(TextView)findViewById(R.id.tv45);
    ...
    public void changeBack()
    {
        switch (pressed)
        {
            case 0:
            {
                screen.setBackgroundResource(R.drawable.flores_2);
                break;
            }
            case 1:
            {
                screen.setBackgroundResource(R.drawable.flores_3);
                break;
            }
            case 2:
            {
                screen.setBackgroundResource(R.drawable.flores_4);
                break;
            }
            case 3:
            {
                screen.setBackgroundResource(R.drawable.flores_5);
                break;
            }
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_fourty_fifth_level, menu);
        return true;
    }
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            if(Dgame.gamePrefs.getInt("levelPassed",0)<45)
            {
                Dgame.scoreEdit.putInt("levelPassed", 45);
