...
public class SecondLevel extends AppCompatActivity{
            ...
            reloj = new CountDownTimer(cincoMil, 1) {
                ...
                public void onFinish() {
                    if (pressed == Dgame.BOMBAS) {
                        ...
                        score = 5 / ((endTime - startTime) / 1000);
    ...
    public void loading()
    {
        ...
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(1);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<2)
            {
                Dgame.scoreEdit.putInt("levelPassed", 2);
