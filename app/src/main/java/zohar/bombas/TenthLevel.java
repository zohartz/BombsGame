...
public class TenthLevel extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dgame.currLevel=9;
        t=(TextView)findViewById(R.id.tv10);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(9);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<10)
            {
                Dgame.scoreEdit.putInt("levelPassed", 10);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tenth_level, menu);
        return true;
    }
    @Override
