...
public class TwentyFirstLevel extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twenty_first_level);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(20);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<21)
            {
                Dgame.scoreEdit.putInt("levelPassed", 21);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_twenty_first_level, menu);
        return true;
    }
