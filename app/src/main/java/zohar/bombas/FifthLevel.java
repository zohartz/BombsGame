...
public class FifthLevel extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dgame.currLevel=4;
        t=(TextView)findViewById(R.id.tv5);
        reloj=new CountDownTimer(cuatroMil,1) {
            @Override
    ...
    public void bombPressed(View v)
    {
        if(!v.getTag().equals("touched")) {
            ...
            if (pressed == Dgame.BOMBAS - 1) {
                ...
                {
                    pressed++;
                    cuatroMil = 4000;//cuatroMil+leftTime;
                    reloj.start();
                } else
                    add();
            }
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(4);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<5)
            {
                Dgame.scoreEdit.putInt("levelPassed", 5);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_fifth_level, menu);
        return true;
    }
