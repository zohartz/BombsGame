...
public class SeventeenthLevel extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seventeenth_level);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(16);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<17)
            {
                Dgame.scoreEdit.putInt("levelPassed", 17);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_seventeenth_level, menu);
        return true;
    }
