...
public class ForthLevel extends AppCompatActivity{
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(3);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<4)
            {
                Dgame.scoreEdit.putInt("levelPassed", 4);
            ...
            Intent intent = new Intent(this, FifthLevel.class);
            startActivity(intent);
            Dgame.setHighScoreX(4);
            overridePendingTransition(R.anim.push_left_in, R.anim.push_left_in);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_forth_level, menu);
        return true;
    }
