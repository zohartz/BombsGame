...
public class EleventhLevel extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eleventh_level);
        Dgame.gamePrefs= getSharedPreferences(Dgame.GAME_PREFS, 0);
        Dgame.currLevel=10;
        t=(TextView)findViewById(R.id.tv11);
    ...
    public void bombPressed(View v)
    {
        if(!v.getTag().equals("touched"))
        {
            ...
            if (pressed == Dgame.BOMBAS - 1) {
                ...
                {
                    pressed++;
                    cincoMil = 3000;//cincoMil+leftTime;
                    reloj.start();
                } else
                    add();
            }
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(10);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<11)
            {
                Dgame.scoreEdit.putInt("levelPassed", 11);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_eleventh_level, menu);
        return true;
    }
