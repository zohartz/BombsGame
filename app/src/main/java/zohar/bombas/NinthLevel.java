...
public class NinthLevel extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ninth_level);
        Dgame.gamePrefs= getSharedPreferences(Dgame.GAME_PREFS, 0);
        Dgame.currLevel=8;
        t=(TextView)findViewById(R.id.tv9);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(8);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<9)
            {
                Dgame.scoreEdit.putInt("levelPassed", 9);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_ninth_level, menu);
        return true;
    }
    @Override
