...
public class FourteenthLevel extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourteenth_level);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(13);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<14)
            {
                Dgame.scoreEdit.putInt("levelPassed", 14);
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        getMenuInflater().inflate(R.menu.menu_fourteenth_level, menu);
        return true;
    }
