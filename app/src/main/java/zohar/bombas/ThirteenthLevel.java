...
public class ThirteenthLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thirteenth_level);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(12);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<13)
            {
                Dgame.scoreEdit.putInt("levelPassed", 13);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_thirteenth_level, menu);
        return true;
    }
