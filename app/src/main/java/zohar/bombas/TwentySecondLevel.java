...
public class TwentySecondLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twenty_second_level);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(21);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<22)
            {
                Dgame.scoreEdit.putInt("levelPassed", 22);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_twenty_second_level, menu);
        return true;
    }
