...
public class ThirdLevel extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdPlayer= MediaPlayer.create(ThirdLevel.this,R.raw.tik_tok);
    ...
    public void loading()
    {
        if(!Dgame.xtreme)
        {
            ...
            setScore();
            Dgame.setHighScoreLento(2);
            if(Dgame.gamePrefs.getInt("levelPassed",0)<3)
            {
            Dgame.scoreEdit.putInt("levelPassed", 3);
